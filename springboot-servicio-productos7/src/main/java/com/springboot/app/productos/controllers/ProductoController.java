...
public class ProductoController {
	...
	@GetMapping("/ver/{id}")
	public Producto detalle(@PathVariable(value="id")Long id) throws InterruptedException {
	...
	//CON REQUESTBODY SE CAPTURA EL PRODUCTO CREADO CON JSON, DESDE EL CUERPO DE LA PETICIÓN.
	@PostMapping("/crear")
